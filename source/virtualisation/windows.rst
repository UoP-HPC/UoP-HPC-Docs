...
Click load drivers once more and this time go to :plaintext:`virtio-win` > :plaintext:`NetKVM` > :plainext:`w11` > :plaintext:`amd64` and install the 'Red Hat VirtIO Ethernet Adapter'.
